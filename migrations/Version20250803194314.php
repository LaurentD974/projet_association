 ...
 */
final class Version20250803194314 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE event CHANGE type type VARCHAR(50) NOT NULL, CHANGE description description LONGTEXT NOT NULL');
    }
